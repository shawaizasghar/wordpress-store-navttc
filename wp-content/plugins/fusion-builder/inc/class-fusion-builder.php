...
class FusionBuilder {
	...
	public function add_element_media_query_styles() {
		...
		// Native sticky.
		$small_css  .= '.awb-sticky.awb-sticky-small{ position: sticky }';
		$medium_css .= '.awb-sticky.awb-sticky-medium{ position: sticky }';
		$large_css  .= '.awb-sticky.awb-sticky-large{ position: sticky }';
